...
const PortfolioLanding = () => {
  let title = "About Me",
    description =
      "I'm a full-stack web-developer focus in e-commerce and interested in product development. Creative, always learning and willing to join in interesting projects.";
  return (
    <div>
